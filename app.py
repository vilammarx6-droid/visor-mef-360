...
# Botón de Facebook
st.sidebar.markdown("""
<a href="https://www.facebook.com/profile.php?id=61589026953016" target="_blank" style="text-decoration: none;">
    <button style="width: 100%; background-color: #1877F2; color: white; border: none; padding: 10px; border-radius: 5px; font-weight: bold; cursor: pointer; margin-bottom: 15px; display: flex; justify-content: center; align-items: center; gap: 8px;">
...
with st.sidebar.expander("💖 Apoya el Proyecto (Donaciones)"):
    ...
    st.info("Sube tu archivo QR aquí próximamente.")
